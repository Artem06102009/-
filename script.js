    ...
    const problems = [
      {
        ...
        {
            text: "В треугольнике ABC известно, что AB = 5, BC = 12, ∠C = 90°. Найдите радиус описанной около этого треугольника окружности.",
            AB: 5,
            BC: 12,
            correctAnswer: 6.5,
            steps: [
                { label: "AB² + BC² = ", answer: 5 * 5 + 12 * 12 },
                { label: "AC² = ", answer: 169 },
                { label: "AC = √", answer: 13 },
                { label: "R = AC / 2 = ", answer: 13 / 2 }
            ]
        },
        {
            text: "В треугольнике ABC известно, что AB = 24, BC = 7, ∠C = 90°. Найдите синус ∠А.",
            AB: 24,
            BC: 7,
            correctAnswer: 0.28,
            steps: [
                { label: "AC = √(AB² - BC²) = ", answer: Math.sqrt(24*24 - 7*7)},
                { label: "sin(A) = BC / AB = ", answer: 7/25 }
            ]
        },
        {
            text: "В треугольнике ABC известно, что AB = BC = AC = 2√3. Найдите высоту CH.",
            side: 2 * Math.sqrt(3),
            correctAnswer: 3,
            steps: [
                { label: "CH = (AB * √3) / 2 = ", answer: (2 * Math.sqrt(3) * Math.sqrt(3)) / 2 }
            ]
        },
        {
            text: "В треугольнике ABC известно, что BC = AC, ∠C = 120°, AC = 2√3. Найдите высоту AB.",
            AC: 2 * Math.sqrt(3),
            angleC: 120,
            correctAnswer: 3,
            steps: [
                { label: "∠A = (180° - ∠C) / 2 = ", answer: (180 - 120) / 2 },
                { label: "AB = 2 * AC * cos(∠A) = ", answer: 2 * (2 * Math.sqrt(3)) * Math.cos(30 * Math.PI / 180) }
            ]
        }
    ];
...
function generateProblem() {
    const problemTypeChoice = Math.random() < 0.5 ? 1 : 2;
    let problem;
